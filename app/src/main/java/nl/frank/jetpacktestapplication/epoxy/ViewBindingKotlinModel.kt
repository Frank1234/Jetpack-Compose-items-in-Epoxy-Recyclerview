...
enum class SpanSize {
    /**
     * Spans a complete column or row.
     */
    TOTAL,
 ...
 * Code copied from Epoxy samples: https://github.com/airbnb/epoxy/blob/master/kotlinsample/src/main/java/com/airbnb/epoxy/kotlinsample/helpers/ViewBindingKotlinModel.kt
 */
abstract class ViewBindingKotlinModel<T : ViewBinding>(
    @LayoutRes private val layoutRes: Int,
    private val spanSize: SpanSize
) : EpoxyModel<View>() {
